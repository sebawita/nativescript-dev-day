    ...
    $(document).ready(function () {
        ...
        if ($('#lgx-typed-string').length) {
            $('#lgx-typed-string').typed({
                strings: ["NativeScript", "Plugins", "Internet of Things", "Mobile App Development", "Angular", "VueJS", "AR/VR", "Performance"],
                // typing speed
                typeSpeed: 10,
        ...
        if (typeof google != 'undefined') {
            ...
            if ($('.map-canvas-default').length) {
                $(".map-canvas-default").googleMap({
                    ...
                    coords: [52.34314, 4.91794, 19], // Map center (optional)
                ...
                $(".map-canvas-default").addMarker({
                    coords: [52.34314, 4.91794, 19], // GPS coords
                    title: 'Nationale Nederlanden',
                    text: 'Spaklerweg 4, 1096 BA Amsterdam, Netherlands',
